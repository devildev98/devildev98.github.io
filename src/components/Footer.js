...
import { Center, Text, Link, Divider, Box, Icon } from "@chakra-ui/react"
import { FaReact } from "react-icons/fa"
import { GrGatsbyjs } from "react-icons/gr"

const Chakraicon = props => (
  <Icon viewBox="0 0 257 257" {...props}>
    ...
    <Box p="2">
      ...
      <Center h="4rem">
        ...
        <Link href="https://reactjs.org/" isExternal>
          <Icon as={FaReact} w={5} h={5} mx={1} color="rgb(83, 220, 251)" />
        </Link>
        <Link href="https://www.gatsbyjs.com/" isExternal>
          <Icon as={GrGatsbyjs} w={5} h={5} mx={1} color="rgb(96, 48, 156)" />
        </Link>
        <Link href="https://chakra-ui.com/" isExternal>
          <Chakraicon w={5} h={5} mx={1} />
        </Link>
      </Center>
    </Box>
  )
